...
if(!$id)exit('ID del usuario onvalido');
...
// echo "</pre>";
// exit;
//^ si han rellenado el formulario del usuario a editar
if($_SERVER['REQUEST_METHOD']==='POST'){
    if(!validateCSRFToken($_POST['csrfToken']??'')){
        ...
        if(empty($errors)){
            ...
            date('Y-m-d H:i:s');
            $sql="UPDATE cursos SET titulo=:titulo, descripcion=:descripcion, duracionHoras=:duracionHoras, nivel=:nivel, fechaInicio=:fechaInicio, fechaFin=:fechaFin, publicado=:publicado, updatedAt=:updatedAt WHERE id=:id";
            $stmt=$pdo->prepare($sql);
            $stmt->execute([
                ':titulo'=>$titulo,
            ...
            registroAuditoria($pdo,'UPDATE','cursos',$u);
    ...
    <div class="container py-5">
        ...
        <form class="row g-3 needs-validation" novalidate method="post">
            ...
            <div class="col-md-8">
                ...
                <input type="text" class="form-control" id="titulo" value="<?= htmlspecialchars($u['titulo']??'') ?>" required name="titulo">
            ...
            <div class="col-md-4">
                ...
                <select class="form-select" id="nivel" name="nivel">
                    ...
                    <option value="MEDIO" <?= ($u['nivel'] ?? '') === 'MEDIO' ? 'selected' : '' ?>>Intermedio</option>
            ...
            <div class="col-md-4">
                ...
                <input type="date" class="form-control" id="fechaInicio" value="<?= htmlspecialchars($u['fechaInicio']??'') ?>" required name="fechaInicio">
                <div class="invalid-feedback">
            ...
            <div class="col-md-4">
                ...
                <input type="date" class="form-control" id="fechaFin" value="<?= htmlspecialchars($u['fechaFin']??'') ?>" required name="fechaFin">
                <div class="invalid-feedback">
            ...
            <div class="col-md-4">
                ...
                <input type="number" class="form-control" id="duracionHoras" value="<?= htmlspecialchars($u['duracionHoras']??'') ?>" required name="duracionHoras">
                <div class="invalid-feedback">
            ...
            <div class="col-md-12">
                ...
                <textarea  class="form-control" id="descripcion" required name="descripcion"><?= htmlspecialchars($u['descripcion']??'') ?></textarea>
                <div class="invalid-feedback">
            ...
            <div class="col-md-4">
                ...
                <input type="checkbox" class="form-check-input" id="publicado" value="1" name="publicado" <?= ($u['publicado'] ?? '') == '1' ? 'checked' : '' ?>>
